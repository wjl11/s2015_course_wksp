...
switch trial
    case 1 % simulate 1 MHz
        f0 = 1; 
    case 2 % simulate 1.5 MHz
        f0 = 1.5; 
end
...
runtime(trial) = toc;
disp(['Simulation time: ' num2str(runtime(trial))]);
%%% GENERATE IMAGE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% images(powcompress(pxducer,1/4))
