function genLesBiasData(IDX)
% jobs 1-7

cd('/getlab/wjl11/scratch/bme844_cluster_jobs/')
addpath('./field_ii')
field_init(-1)
...
scat_amp = [1 10 50 100 150 200 400];
...
for n_amp = IDX
    ...
    save(['./hw8_data' num2str(scat_amp(n_amp)) '_les.mat'],'env','r')
    clear env env_db r
end

if IDX == 1
    save('./hw8_params_les.mat','scat_amp','th_scan','position','ax_res','lat_res')
end
